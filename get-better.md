When you walk into a bookstore, you often find books called ''Teach Yourself Java in 7 Days''. The authors try to convince you that programming is easy when it ''really is not''. Peter Norvig wrote an excellent essay on this topic called [http://norvig.com/21-days.html Teach Yourself Programming in Ten Years] which I highly recommend. See also [http://abstrusegoose.com/249 a comic by Abstruse Goose] on the same topic. I agree with Peter &ndash; it takes a lot of time and effort. However, you should still try to make your training as effective as possible.

There is very little information available about training for programming competitions, so I decided to create a training program, which is probably the first one ever written. It is based on my experience as a competition programmer as well as a semi-professional athlete. Please [[Main_Page#Contact|let me know]] if you have any comments.
...
I recommend you to read the book [http://amzn.com/0262033844 Introduction to Algorithms by Cormen, Leiserson, Rivest and Stein ]. There are also excellent [http://www.topcoder.com/tc?d1=tutorials&d2=alg_index&module=Static algorithm tutorials on TopCoder]. For algorithms classes you should check your university or find some online courses. If you are at KTH, take [http://www.csc.kth.se/utbildning/kth/kurser/DD1352/ Algoritmer, datastrukturer och komplexitet] and [http://www.csc.kth.se/utbildning/kth/kurser/DD2458/ Problemlösning och programmering under press] as soon as possible in your first or second year. Since 2013, the latter is taught by a great programmer [http://community.topcoder.com/tc?module=MemberProfile&cr=7421158 Per Austrin] and some other competition programmers at KTH usually help out.
...
### Failure
Failure is great, it shows you what you did wrong. Also, our brains work in such a way that we learn the most by making mistakes. The following quote is from [http://ideas.time.com/2012/04/25/why-floundering-is-good/ Why Floundering Is Good]:
<blockquote>
...
Since failure is so crucial in the learning process, you need to be able to deal with it. Such quality is called self-compassion in English. The following quote about self-compassion is from [http://blogs.hbr.org/cs/2012/09/to_succeed_forget_self-esteem.html To Succeed, Forget Self-Esteem].
<blockquote>
...
I couldn't say it better. Go ahead and read [http://blogs.hbr.org/cs/2012/09/to_succeed_forget_self-esteem.html the whole article].
